import { IoHomeOutline, IoPhonePortraitSharp } from "react-icons/io5";
      ...
      >
        ...
        <div className="flex flex-col items-center border border-red-600">
          ...
          <div className="flex mb-8 max-w-[370px] w-full">
            ...
            <div className="w-full">
              <h4 className="font-bold text-dark text-xl mb-1">Resume</h4>
              <p className="text-base text-body-color">Click to view</p>
            </div>
          </div>
        </div>
      </section>
